...
public class DeviceTemplateTiggerInfo extends BaseBean {
   ...
   public DeviceTemplateTiggerInfo(String name, Integer from_sensor_id, Integer to_sensor_id, Integer iot_trigger_condition_type, String iot_trigger_action_type, String action_params, Integer seq, String condition_params, Integer iot_trigger_alarm_level, Integer iot_trigger_alarm_flag, Integer trigger_inteval_time, Integer aid, Date atime, Integer mid, Date mtime, Integer device_template_id) {
      this.name = name;
   ...
   public DeviceTemplateTiggerInfo(String sensor_name, Integer scene_id, Integer user_id, String start_time, String end_time, Integer id, List<Integer> id_array, Integer delete_flag, Integer offset, Integer limit, Map<String, String> data, String name, Integer from_sensor_id, Integer to_sensor_id, Integer iot_trigger_condition_type, String iot_trigger_action_type, String action_params, Integer seq, String condition_params, Integer iot_trigger_alarm_level, Integer iot_trigger_alarm_flag, Integer trigger_inteval_time, Integer aid, Date atime, Integer mid, Date mtime, Integer device_template_id) {
   ...
   public DeviceTemplateTiggerInfo(Integer id, List<Integer> id_array, Integer delete_flag, Integer offset, Integer limit, Map<String, String> data, String name, Integer from_sensor_id, Integer to_sensor_id, Integer iot_trigger_condition_type, String iot_trigger_action_type, String action_params, Integer seq, String condition_params, Integer iot_trigger_alarm_level, Integer iot_trigger_alarm_flag, Integer trigger_inteval_time, Integer aid, Date atime, Integer mid, Date mtime, Integer device_template_id) {
   ...
   public DeviceTemplateTiggerInfo() {
   }
